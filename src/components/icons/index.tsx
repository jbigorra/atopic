...
export function PlusFilledIcon({ width = 32, height = 32 }: MGIconProps) {
  return (
    <svg width={width} height={height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-reactroot="">
      <path fill="#85D0CC" d="M10.5 4.5C10.5 3.66772 11.1677 3 12 3C12.8323 3 13.5 3.66772 13.5 4.5V19.5C13.5 20.3323 12.8323 21 12 21C11.1677 21 10.5 20.3323 10.5 19.5V4.5Z" clip-rule="evenodd" fill-rule="evenodd" undefined="0" transform="translate(2,2)"></path><path fill="#98EED5" d="M10.5 4.5C10.5 3.66772 11.1677 3 12 3C12.8323 3 13.5 3.66772 13.5 4.5V19.5C13.5 20.3323 12.8323 21 12 21C11.1677 21 10.5 20.3323 10.5 19.5V4.5Z" clip-rule="evenodd" fill-rule="evenodd" undefined="1"></path>
      <path fill="#85D0CC" d="M3 12C3 11.1677 3.66772 10.5 4.5 10.5H19.5C20.3323 10.5 21 11.1677 21 12C21 12.8323 20.3323 13.5 19.5 13.5H4.5C3.66772 13.5 3 12.8323 3 12Z" clip-rule="evenodd" fill-rule="evenodd" undefined="0" transform="translate(2,2)"></path><path fill="#98EED5" d="M3 12C3 11.1677 3.66772 10.5 4.5 10.5H19.5C20.3323 10.5 21 11.1677 21 12C21 12.8323 20.3323 13.5 19.5 13.5H4.5C3.66772 13.5 3 12.8323 3 12Z" clip-rule="evenodd" fill-rule="evenodd" undefined="1"></path>
    </svg>
  );
}
