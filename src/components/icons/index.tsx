...
export function RobotFilled({ width = 48, height = 48 }: MGIconProps) {
  return (
    <>
      <svg width={width} height={height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" dataReactroot="">
        <path fill="#85D0CC" d="M21 14H20V9H21C21.55 9 22 9.45 22 10V13C22 13.55 21.55 14 21 14Z" undefined="0" transform="translate(2,2)"></path><path fill="none" d="M21 14H20V9H21C21.55 9 22 9.45 22 10V13C22 13.55 21.55 14 21 14Z" undefined="1"></path>
        <path fill="#85D0CC" d="M3 9H4V14H3C2.45 14 2 13.55 2 13V10C2 9.45 2.45 9 3 9Z" undefined="0" transform="translate(2,2)"></path><path fill="none" d="M3 9H4V14H3C2.45 14 2 13.55 2 13V10C2 9.45 2.45 9 3 9Z" undefined="1"></path>
        <path fill="#98EED5" d="M18 19H6C4.9 19 4 18.1 4 17V7C4 5.9 4.9 5 6 5H18C19.1 5 20 5.9 20 7V17C20 18.1 19.1 19 18 19Z" undefined="0" transform="translate(2,2)"></path><path fill="none" d="M18 19H6C4.9 19 4 18.1 4 17V7C4 5.9 4.9 5 6 5H18C19.1 5 20 5.9 20 7V17C20 18.1 19.1 19 18 19Z" undefined="1"></path>
        <path fill="#85D0CC" d="M15.25 12.5C16.2165 12.5 17 11.7165 17 10.75C17 9.7835 16.2165 9 15.25 9C14.2835 9 13.5 9.7835 13.5 10.75C13.5 11.7165 14.2835 12.5 15.25 12.5Z" undefined="0" transform="translate(2,2)"></path><path fill="none" d="M15.25 12.5C16.2165 12.5 17 11.7165 17 10.75C17 9.7835 16.2165 9 15.25 9C14.2835 9 13.5 9.7835 13.5 10.75C13.5 11.7165 14.2835 12.5 15.25 12.5Z" undefined="1"></path>
        <path fill="#85D0CC" d="M8.75 12.5C9.7165 12.5 10.5 11.7165 10.5 10.75C10.5 9.7835 9.7165 9 8.75 9C7.7835 9 7 9.7835 7 10.75C7 11.7165 7.7835 12.5 8.75 12.5Z" undefined="0" transform="translate(2,2)"></path><path fill="none" d="M8.75 12.5C9.7165 12.5 10.5 11.7165 10.5 10.75C10.5 9.7835 9.7165 9 8.75 9C7.7835 9 7 9.7835 7 10.75C7 11.7165 7.7835 12.5 8.75 12.5Z" undefined="1"></path>
